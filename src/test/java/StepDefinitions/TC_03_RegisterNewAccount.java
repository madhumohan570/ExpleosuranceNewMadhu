...
public class TC_03_RegisterNewAccount {
	...
	public void user_provides_the_details_of_new_user() {
		...
		driver.findElement(By.xpath("//input[@id='email']")).sendKeys("Maniraj@gmail.com");
	...
	public void user_enters_email_and_password() {
	  ...
	  driver.findElement(By.xpath("//input[@placeholder='Email Address']")).sendKeys("Maniraj@gmail.com");
